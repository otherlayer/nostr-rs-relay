...
pub struct Grpc {
    ...
    pub enable_relay_server: Option<bool>,
    pub relay_server_port: u32,
}
...
pub struct Limits {
    ...
    pub event_submit_buffer: usize, // incomming submitted events buffer
